...
print("ln(x) + ln(2x) = 3 => SVAR: x1 = ", math.sqrt(math.e**3/2), ", x2 = ", -1*math.sqrt(math.e**3/2))

# e^2x - 5e^x = -6 => e^x*(e^2-5) = -6 => e^x = -6/(e^2-5) => x = ln(-6/(e^2-5)) => saknar lösning då ln(x) ∈ [0, ∞) för x ∈ ℝ.
print("e^2x - 5e^x = -6 => e^x*(e^2-5) = -6 => e^x = -6/(e^2-5) => x = ln(-6/(e^2-5)). e^2-5 > 0 => -6/(e^2-5) < 0 => SVAR: x = ln(-6/(e^2-5)) saknar lösning eftersom ln(x) ∈ [0, ∞) för x ∈ ℝ.")